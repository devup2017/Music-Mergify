        ...
        dispatch_async(dispatch_get_main_queue(), ^(void)
                       {
                           ...
                           //NSLog(@"%@",[NSString stringWithFormat:@"https://soundcloud.com/connect?client_id=%@&redirect_uri=%@&response_type=code",CLIENT_ID,REDIRECT_URI]);
                           
                           //[self openLoginViewController];
                           [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://soundcloud.com/connect?client_id=%@&redirect_uri=%@&response_type=code&scope=non-expiring",CLIENT_ID,REDIRECT_URI]]];
                       });
        return false;
        }
    }
...
- (void)doOauthWithCode: (NSString *)code {
    ...
    NSString *postString =[NSString stringWithFormat:@"client_id=%@&client_secret=%@&grant_type=authorization_code&scope=non-expiring&redirect_uri=%@&code=%@",CLIENT_ID,CLIENT_SECRET,REDIRECT_URI,code];
