...
#define kPopupModalAnimationDuration 0.30
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    overlayView.backgroundColor = [UIColor colorWithRed:0.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:0.05];
...
- (void)fadeViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView
{
    ...
    CGSize sourceSize = sourceView.bounds.size;
    CGSize popupSize = popupView.bounds.size;
    //CGRect popupEndRect = CGRectMake((sourceSize.width - popupSize.width) / 2,((sourceSize.height - popupSize.height) / 2)-160,              popupSize.width,       popupSize.height);
    CGRect popupEndRect = CGRectMake((sourceSize.width - popupSize.width) / 2,
                                     ((sourceSize.height - popupSize.height) / 2),
                                     popupSize.width,
                                     popupSize.height);
