...
//SCREEN_WIDTH==320?65:(SCREEN_WIDTH==375?80:90)
static CGFloat kYSLScrollMenuViewWidth  = 0;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        kYSLScrollMenuViewWidth = SCREEN_WIDTH==320?65:(SCREEN_WIDTH==375?80:90);
        
        _viewbackgroudColor = [UIColor whiteColor];
        //_itemfont = [UIFont fontWithName:@"Helvetica" size:16];
        
        _itemTitleColor = [UIColor whiteColor];
        _itemSelectedTitleColor = [CommonUtils colorFromHexString:H_RED_COLOR];
        _itemIndicatorColor = [CommonUtils colorFromHexString:H_RED_COLOR];;
...
- (void)setItemTitleArray:(NSArray *)itemTitleArray
{
    if (_itemTitleArray != itemTitleArray) {
        ...
        for (int i = 0; i < itemTitleArray.count; i++) {
            ...
            //itemView.font = [UIFont fontWithName:@"Helvetica" size:16];
            ...
            /*
            CGRect frameSeprator = CGRectMake(78*(i+1), 13, 1, 15);
            UILabel *seprator = [[UILabel alloc] initWithFrame:frameSeprator];
            seprator.backgroundColor = [UIColor redColor];
            [self.scrollView addSubview:seprator];
            //[views addObject:seprator];
            */
        }
