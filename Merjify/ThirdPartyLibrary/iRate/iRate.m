...
- (void)promptForRating
{
    if (!self.visibleAlert)
    {
        ...
        {
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:self.messageTitle message:message delegate:(id<UIAlertViewDelegate>)self cancelButtonTitle:nil otherButtonTitles:self.rateButtonLabel, nil];
